...
$base_url = ($current_url === $current_url_check . '/videos/ceo-podcast/') ? '' : '/cancervax-inhouse';
...
$filteredCEOPodcastVideos = array_filter($videos, function ($item) use ($videoTitleFromURL) {
    return $item['category'] === 'ceo-podcast' && $item['scope'] === 'public' && strtolower($item['title']) === $videoTitleFromURL;
});
        ...
        <div class="container">
            <div class="abtceo-wrap">
                <div class="abt-ceo-img">
                    <img src="<?php echo $base_url; ?>/assets/img/Ryan-Davies.png" alt="ryan">
                </div>
